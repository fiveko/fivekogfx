...
*/
window.addEventListener("load",function(a){function h(a){var b=a.width||a.videoWidth;a=a.height||a.videoHeight;var c=(480<document.documentElement.clientWidth?480:document.documentElement.clientWidth-100)/Math.max(b,a);k.width=b*c;k.height=a*c}function d(a,b){var c=document.getElementsByTagName("video")[0];if(!c){var l=function(){c.play();c.muted=!0;h(c);clearInterval(d);d=setInterval(function(){document.getElementById("cmbFilters").getFilter().update()},30)},d,c=document.createElement("video");c.addEventListener("canplaythrough",
l,!0);c.addEventListener("ended",function(){clearInterval(d)},!0);k.onclick=function(){c.paused?l():(c.pause(),clearInterval(d))}}"srcObject"in c?c.srcObject=a:(window.URL.revokeObjectURL(c.src),c.src=window.URL.createObjectURL(a));window.redraw=function(){k.getContext("2d").drawImage(c,0,0,k.width,k.height)}}function b(a,b){g.onload=function(){h(this);k.getContext("2d").drawImage(this,0,0,k.width,k.height);b()};window.redraw=function(){k.getContext("2d").drawImage(g,0,0,k.width,k.height)};a?"string"===
